...
@section('breadcrumbs')
{{ Helper::breadcrumbs('Reports', 'Programme KPIs') }}
@stop
@section('left_side')
{{ Helper::left_side('Reports', 'Programme KPIs') }}
@stop
@section('content')
<div class="row">
                    ...
                    <div class="widget-body no-padding">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <?php GeneralFunctions::get_person(); ?>
