...
{{ Helper::breadcrumbs('Reports & Analysis', 'Participation Analysis') }}
...
{{ Helper::left_side('Reports & Analysis', 'Participation Analysis') }}
...
$(function() {
    ...
    $.ajax({
        ...
        url: '{{ route("activity-barometer.postGraphBubble") }}',
