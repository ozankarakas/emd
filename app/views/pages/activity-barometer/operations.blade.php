...
{{ Helper::breadcrumbs('Reports & Analysis', 'Programme Analysis') }}

@stop

@section('left_side')

{{ Helper::left_side('Reports & Analysis', 'Programme Analysis') }}
...
$(function() {
    ...
    $.ajax({
        ...
        url: '{{ route("activity-barometer.postReportOperations") }}',
