...
@section('breadcrumbs')
{{ Helper::breadcrumbs('Analaysis', 'Rate of Churn') }}
@stop
@section('left_side')
{{ Helper::left_side('Analaysis', 'Rate of Churn') }}
@stop
@section('content')
<div class="row">
                    ...
                    <div class="widget-body no-padding">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <?php GeneralFunctions::get_booking(); ?>
                                <?php GeneralFunctions::get_location(); ?>
                                <div id="lc_div"></div>
                                <?php GeneralFunctions::get_programme(); ?>
                            </div>
                            <div class="form-group col-sm-6">
                              <?php GeneralFunctions::get_start_date(); ?>  
                              <?php GeneralFunctions::get_end_date(); ?>   
                              <?php GeneralFunctions::get_period(); ?>
                              <?php GeneralFunctions::get_count(); ?>
                              <?php GeneralFunctions::get_frequency(); ?>
